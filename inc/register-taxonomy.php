...
/**
 * Taxonomy: Grants Focus Area
 */
function taxonomy_grants_focus_area() {
    $labels = array(
    ...
    register_taxonomy( 'grants-focus-area', 'grants', $args );
}

add_action( 'init', 'taxonomy_grants_focus_area' );

/**
 * Taxonomy: Grants Organization Name
 */
function taxonomy_grants_organization_name() {
    $labels = array(
    ...
    register_taxonomy( 'grants-organization-name', 'grants', $args );
}

add_action( 'init', 'taxonomy_grants_organization_name' );

/**
 * Taxonomy: Grants Funding Type
 */
function taxonomy_grants_funding_type() {
    $labels = array(
    ...
    register_taxonomy( 'grants-funding-type', 'grants', $args );
}

add_action( 'init', 'taxonomy_grants_funding_type' );

/**
 * Taxonomy: Research Updates Content Type
 */
function taxonomy_research_updates_content_type() {
    $labels = array(
    ...
    register_taxonomy( 'research-updates-content-type', 'research-updates', $args );
}

add_action( 'init', 'taxonomy_research_updates_content_type' );

/**
 * Taxonomy: Research Updates Focus Area
 */
function taxonomy_research_updates_focus_area() {
    $labels = array(
        'name'              => _x( 'Focus Area', 'taxonomy general name', 'oph' ),
        'singular_name'     => _x( 'Focus Area', 'taxonomy singular name', 'oph' ),
        'add_new_item'      => __( 'Add New Focus Area', 'oph' ),
    ...
    register_taxonomy( 'research-updates-focus-area', 'research-updates', $args );
}

add_action( 'init', 'taxonomy_research_updates_focus_area' );