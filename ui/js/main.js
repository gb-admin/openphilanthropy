jQuery(function($) {
   ...
   */
  $( document ).ready( function() {
    var element = $( '.prevent-orphan, .footer-grid__cell h4, .footer-grid__cell button, .footer-grid__cell .button, .page-header .entry-content p' );
  ...
  $( '.logos-reel' ).slick( {
    appendArrows: $( '.logos-reel-content' ),
    autoplay: true,
    autoplaySpeed: 1000,
    centerMode: true,
    nextArrow: nextArrow,
  ...
  $( '.logos-reel .slick-slide' ).on( 'click', function( e ) {
  ...
  var logos_reel = function() {
    var logos_reel = $( '.logos-reel' );

    if ( window.matchMedia( '(min-width: 1024px)' ).matches ) {
      logos_reel.slick( 'slickSetOption', {
        slidesToShow: 4
      }, true );
    } else if ( window.matchMedia( '(min-width: 768px)' ).matches ) {
      logos_reel.slick( 'slickSetOption', {
