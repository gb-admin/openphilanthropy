...
function enqueue_asset() {
	...
	wp_enqueue_style( 'main-style', get_template_directory_uri() . '/ui/css/main.min.css', array(), '1.0.0' );
	...
	wp_enqueue_script( 'main-script', get_template_directory_uri() . '/ui/js/main.js', array( 'jquery', 'js-cookie' ), '1.1.0', true );
