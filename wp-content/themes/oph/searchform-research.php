<form class="search-form" action="/" method="get">
	<label for="search-research">Search in Research</label>

	<input class="search-field" id="search-research" type="search" name="s" placeholder="Search" value="<?php the_search_query(); ?>">
